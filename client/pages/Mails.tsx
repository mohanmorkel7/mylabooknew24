              ...
              {Object.entries(groupEmailsByDay(emails)).map(
                ([groupLabel, groupEmails]) => (
                  <div key={groupLabel}>
                    ...
                    <Accordion type="single" collapsible onValueChange={async (val) => {
                      if (!val) return;
                      try {
                        ...
                        setEmails((prev) => prev.map((it) => (it.id === val ? { ...it, body: fullBody, bodyPreview: data?.bodyPreview || it.bodyPreview } : it)));
                      } catch (e) {
                        // ignore
                      }
                    }}>
